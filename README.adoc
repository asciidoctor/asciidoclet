...
:asciidoclet-powered-ref: https://github.com/asciidoctor/asciidoclet/blob/master/src/docs/asciidoc/asciidoclet-powered.adoc
...
We have a {asciidoclet-powered-ref}[Powered by AsciiDoclet] page. If you have an example of nifty JavaDoc powered by AsciiDoclet, please send us a pull request.
